...
/*
    template <typename T>
    double noise(T x) {
        return pnoise_int.noise(double(x));
    } 
    
    template <typename T, typename U>
    double noise(T x, U y) {
        return pnoise_int.noise(double(x), double(y));
    } 
    
    template <typename T, typename U, typename V>
    double noise(T x, U y, V z) {
        return pnoise_int.noise(double(x), double(y), double(z));
    }
*/                     
